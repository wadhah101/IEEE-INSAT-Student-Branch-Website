...
const ChapterElement: React.FC<IChapterElementProps> = ({
    data,
    className
}) => {
    ...
    return (
        <div
            className={clsx(
                'flex justify-self-stretch  h-full w-full relative rounded md:bg-transparent bg-white items-center md:duration-300 ',
                [isHovering ? 'md:bg-white' : 'md:bg-transparent'],
                className
            )}
            onMouseEnter={() =>
                setIsHoveringMulti((e) => ({ ...e, out: true }))
            }
            onMouseLeave={() =>
                setIsHoveringMulti((e) => ({ ...e, out: false }))
            }
        >
            {/* social media */}
            <div
                ...
                className={clsx(
                    'absolute bottom-0 left-0 flex duration-300 items-center justify-center w-full h-12 md:gap-4 gap-3 text-2xl text-opacity-95 transform',
                    isHovering
            ...
            <div className="relative">
                ...
                >
                    <GatsbyImage
                        onMouseEnter={() =>
                            setIsHoveringMulti((e) => ({ ...e, in: true }))
                        }
                        onMouseLeave={() =>
